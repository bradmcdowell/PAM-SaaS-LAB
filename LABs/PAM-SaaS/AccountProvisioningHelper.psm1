#currently not working properly due to variable transfer error?
function Start-LoggingSession {
    [CmdletBinding()]
    param()
    $logPath = Join-Path $PWD "AccountProvisioningOutput.txt"
    Write-Host "Log file location: $logPath"
    Start-Transcript -Path $logPath -Append
}

#Import ActiveDirectory module after checking the required components are present 
function Import-ADModuleSafe {
    ...
    try {
        ...
        Stop-Transcript
        throw # Re-throws to terminate the calling script
    }
}
...
function Get-AdminCredential {
    [CmdletBinding()]
    param(
        [string] $PromptMessage = "Enter Domain Admin level credentials for acme\mike_da"
    )
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCChUGkV0CMamTm
# hBvhI7m2d+vrWvRLkXcu0fk9gZKCvqCCGNIwggWNMIIEdaADAgECAhAOmxiO+dAt
...
# AQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIF11b4ZRDNEY+JYE0lBFjb/dUKOuHj1Y
# TUsZTFgZVVD1MA0GCSqGSIb3DQEBAQUABIIBACb+CxFTvXGJFNoTqEAGjUsLzeeC
# 2R56DjnrKN5nR7piDsQrJFau7cv9BtWO2DwxwW2srkcNxpi+tl16imu9oG8XyxVS
# 5aR/gIeZlpDy3sUrneiDYiOkDjxVi5h5wvKrz8VqLM0N0kpMtMeTd7g44Oqf1nzG
# Ns7KHLw2jxA1b5sUha1Hn5VcTHyRsl3N+VUm7wLtiblqGuiO/OvnWEi8KaQLb2bk
# j1pa62EJCxxtbdDDyFcGxcB6Ho1HvbL+6r23xrNgRg2SbiG/xUeyb6PTUo6TrL0X
# IE888sdORSZ1cpYwqCB5/fAEbOGkU1kVE1qKTSqkIsvDdUV91ZgwXlvNcDChggMm
...
# DQEHATAcBgkqhkiG9w0BCQUxDxcNMjUxMjAyMDgzNDEzWjAvBgkqhkiG9w0BCQQx
# IgQguj4JfZQk2VC/FBtH1H41u0kJ+mUD9+hHVydaTa8wmWowDQYJKoZIhvcNAQEB
# BQAEggIAkTC3cGe0LPwADl7VzdYGz0GaAjSPy9gAYf+xfDEkctFTO9HqJZgtnFdI
# gDo0p7RYa7O0SFtgSk5oEHW9IQRIuW/rokI8OmplL3fU95LjQmr1OS4vM53a1osJ
# yXefLpZfzznH/kOOY3dEGuHqyXumfqEVG0tE7rI6b191myH61ZrU/HskRzFskMRX
# AhlhKtmlpxm/11S/KZ4DlUzk4ppXSv9JfSMcK8tfrlDyAHp+iGzz5497vpE9p6aj
# xxlAAss2OpEb9GeaLYpkxV4+YHF59TUNB0pNvFdSw/FMX8FqzlXyBFeHPoQJR7Qh
# TZhyUl2A4f/DbFvRf5bSsTTa7cY5CYTBiYynoTPZwWx/w/CFPtaDooYo5lX9aH+X
# De38O8tzPtsmD1ySC0bXsaK/dtX62cLG//n3PEQYZ2CN7JJBQKYDFy2vhNksLpnV
# FwpmIHKlu5I1nY7J8W/ZaNuD2LjO+a+t8ry/PSK1uCYh5ZNZRElxiVxZybKL5vcc
# am1SSiqECZWPrR0xCEvTApjbMQWyaTPTE4Fu41lZ7IAHBo1RD9iU6r+KfqOtql1+
# c6NYgCwY7DbAGgNjBj2mHfnxzDY9gaIskRbZ9L/dPLE+GVFY/coctBwZrqnjInvT
# F9Wo5pokXy4Pb3sBeiR9TJqVDGKltRpwjMQo5QLFVv+coXheQ18=
